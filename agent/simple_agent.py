    ...
    def _build_services(self) -> AgentServices:
        return AgentServices(
            ...
            config={
                ...
                "play_unit_min_chars": self.config.stream.play_unit_min_chars,
                "play_unit_max_chars": self.config.stream.play_unit_max_chars,
                "visual_stream_workers": self.config.stream.visual_stream_workers,
            },
            logger=log_timing,
