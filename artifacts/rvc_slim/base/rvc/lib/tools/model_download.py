...
# LOCAL PATCH (Spica): now_dir anchored to the Applio root via this file (was
# os.getcwd() -- cwd races with the TTS pushd; note os.chdir(now_dir) below now
# deterministically targets the Applio root). Do not overwrite on upstream sync.
